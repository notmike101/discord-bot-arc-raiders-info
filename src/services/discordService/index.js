...
import { Client, GatewayIntentBits, Collection, Events, Routes, REST, MessageFlags } from 'discord.js';
...
export class DiscordService {
  ...
  async #registerCommands() {
    ...
    try {
      this.#rest.put(Routes.applicationGuildCommands(this.#clientId, this.#guildId), { body: commands });
    } catch(err) {
      console.error(err);
    }
  }
  ...
  /**
   * @param { * @param {import("discord.js").ChatInputCommandInteraction | import("discord.js").AutocompleteInteraction} interaction 
   */
